...
float64 __cdecl arcsin(float64 _X) { return __IBM_ASINF64(_X, 0); }
float64 __cdecl arccos(float64 _X) { return __IBM_ACOSF64(_X, 0); }
...
__Float64 __cdecl __IBM_ASINF64(__Float64 x, bool RadUnit)
{
    ...
    auto _ConvertUnit = [RadUnit](float64 x) {return RadUnit ? (x) : Degrees(x);};
...
__Float64 __cdecl __IBM_ACOSF64(__Float64 x, bool RadUnit)
{
    double x2, xx, res1, p, t, res, r, cor, cc, y, c, z;
    __Float64 u, v;
    int k, m, n;
