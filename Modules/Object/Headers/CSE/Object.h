...
float64 EquatorialCircumference(Object Obj, const SciCxx::IntegralFunction& IFunc = SciCxx::DefaultIntegratingFunction());
float64 MeridionalCircumference(Object Obj, const SciCxx::IntegralFunction& IFunc = SciCxx::DefaultIntegratingFunction());
float64 SurfaceArea(Object Obj, const SciCxx::IntegralFunction &IFunc = SciCxx::DefaultIntegratingFunction());
