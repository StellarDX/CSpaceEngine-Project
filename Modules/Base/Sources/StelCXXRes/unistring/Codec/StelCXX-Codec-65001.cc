    ...
    for (int i = 0; i < size; )
    {
        ...
        else if (c < 0b11110000)
        {
            ...
            *ostr = ((ucs4_t) (c & 0b00001111) << 12)
                | ((ucs4_t) (s[1] ^ 0b10000000) << 6)
                | (ucs4_t) (s[2] ^ 0b10000000);
            i += 3;
        }
        else if (c < 0b11111000)
        {
            if (i + 3 >= size) {return DCRET_TOOFEW(0);}
            if (!((s[1] ^ 0b10000000) < 0b01000000 && (s[2] ^ 0b10000000) < 0b01000000
                && (s[3] ^ 0b10000000) < 0b01000000
                && (c >= 0b11110001 || s[1] >= 0b10010000)))
            {
                return DCRET_ILSEQ;
            }
            *ostr = ((ucs4_t) (c & 0b00000111) << 18)
                | ((ucs4_t) (s[1] ^ 0b10000000) << 12)
                | ((ucs4_t) (s[2] ^ 0b10000000) << 6)
                | (ucs4_t) (s[3] ^ 0b10000000);
            i += 4;
        }
        else if (c < 0b11111100)
        {
            ...
            if (!((s[1] ^ 0b10000000) < 0b01000000 && (s[2] ^ 0b10000000) < 0b01000000
                && (s[3] ^ 0b10000000) < 0b01000000 && (s[4] ^ 0b10000000) < 0b01000000
                && (c >= 0b11111001 || s[1] >= 0b10001000)))
            {
                return DCRET_ILSEQ;
            }
            *ostr = ((ucs4_t) (c & 0b00000011) << 24)
            | ((ucs4_t) (s[1] ^ 0b10000000) << 18)
            | ((ucs4_t) (s[2] ^ 0b10000000) << 12)
            | ((ucs4_t) (s[3] ^ 0b10000000) << 6)
            | (ucs4_t) (s[4] ^ 0b10000000);
            i += 5;
        }
        else if (c < 0b11111110)
        {
            ...
            if (!((s[1] ^ 0b10000000) < 0b01000000 && (s[2] ^ 0b10000000) < 0b01000000
                && (s[3] ^ 0b10000000) < 0b01000000 && (s[4] ^ 0b10000000) < 0b01000000
                && (s[5] ^ 0b10000000) < 0b01000000
                && (c >= 0b11111101 || s[1] >= 0b10000100)))
            {
                return DCRET_ILSEQ;
            }
            *ostr = ((ucs4_t) (c & 0b00000001) << 30)
                | ((ucs4_t) (s[1] ^ 0b10000000) << 24)
                | ((ucs4_t) (s[2] ^ 0b10000000) << 18)
                | ((ucs4_t) (s[3] ^ 0b10000000) << 12)
                | ((ucs4_t) (s[4] ^ 0b10000000) << 6)
                | (ucs4_t) (s[5] ^ 0b10000000);
            i += 6;
        }
        else {return DCRET_ILSEQ;}
        ++ostr;
