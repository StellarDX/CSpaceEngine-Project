...
Angle __cdecl __IBM_ASIN64F(__Float64 x)
{
    ...
    /*---------------------------- |x|>=1 -------------------------------*/
    else if (k == 0x3ff00000 && u.parts.lsw == 0) { return ((m > 0) ? hp0.x : -hp0.x); }
    else { return __Float64::FromBytes(BIG_NAN_DOUBLE).x; };
}
...
Angle __cdecl __IBM_ACOS64F(__Float64 x)
{
    ...
    /*---------------------------- |x|>=1 -----------------------*/
    else if (k == 0x3ff00000 && u.parts.lsw == 0) { return ((m > 0) ? 0 : 2.0 * hp0.x); }
    else { return __Float64::FromBytes(BIG_NAN_DOUBLE).x; }
}
