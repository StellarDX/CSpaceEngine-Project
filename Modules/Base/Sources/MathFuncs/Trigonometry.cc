...
complex64 __cdecl arcsinc(complex64 _X, int _N, int64 _K)
{
    return -1i * lnc(sqrtc(1. - _X * _X)[_N] + 1i * _X, _K);
}

complex64 __cdecl arccosc(complex64 _X, int _N, int64 _K)
{
    return -1i * lnc(1i * sqrtc(1. - _X * _X)[_N] + _X, _K);
}

complex64 __cdecl arctanc(complex64 _X, int64 _K)
{
    return -0.5i * lnc((1i - _X) / (1i + _X), _K);
}

complex64 __cdecl arcctgc(complex64 _X, int64 _K)
{
    return -0.5i * lnc((_X + 1i) / (_X - 1i), _K);
}

complex64 __cdecl arcsecc(complex64 _X, int _N, int64 _K)
{
    return -1i * lnc(1i * sqrtc(1. - 1. / (_X * _X))[_N] + 1. / _X, _K);
}

complex64 __cdecl arccscc(complex64 _X, int _N, int64 _K)
{
    return -1i * lnc(sqrtc(1. - 1. / (_X * _X))[_N] + 1.i / _X, _K);
}
